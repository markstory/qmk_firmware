...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        KC_LSHIFT, KC_Z, KC_X, KC_C, KC_V, KC_B,             KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLASH,  KC_RSHIFT,
               MO(_LOWER), ALT_T(KC_RETURN), GUI_T(KC_ESC),  GUI_T(KC_BSPACE), ALT_T(KC_SPACE), MO(_RAISE)
    ),
    ...
    [_RAISE] = LAYOUT(
        KC_GRAVE,  KC_1, KC_2, KC_3, KC_4, KC_5,             KC_6, KC_7, KC_8,     KC_9,   KC_0,      KC_BSPACE,
        KC_TAB,    KC_Q, KC_W, KC_E, KC_R, KC_T,             KC_Y, KC_U, KC_I,     KC_O,   KC_P,      KC_BSLASH,
        KC_LCTRL,  KC_A, KC_S, KC_D, KC_F, KC_D,             KC_H, KC_J, KC_K,     KC_L,   KC_SCOLON, KC_QUOTE,
        KC_LSHIFT, KC_Z, KC_X, KC_C, KC_V, KC_B,             KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLASH,  KC_RSHIFT,
               MO(_LOWER), ALT_T(KC_RETURN), GUI_T(KC_ESC),  GUI_T(KC_BSPACE), ALT_T(KC_SPACE), MO(_RAISE)
    )
};
